...
alert("Selected Item  " +  txttxt + ", Value " + valval);
            ...
            function Onload_duty_cal1() {
                var t_bcdduty = 0, t_aidcduty = 0, t_eaidcduty = 0, t_ncdduty = 0, t_adcduty = 0, t_cessduty =0, t_Ccess = 0, Ccess = 0, t_chcessduty = 0;
                
                        var objnum = '1234';
                        $('#idbcdamtnew').val(objnum);
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_bcdduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_aidcduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_eaidcduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_ncdduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_adcduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_cessduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_Ccess = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            Ccess = document.getElementById("t_igst_rate").innerHTML;
                        }
                        if(document.getElementById("t_igst_rate").innerHTML != "undefined") {
                            t_chcessduty = document.getElementById("t_igst_rate").innerHTML;
                        }
                        
                        var spnval = $('#t_igst_rate').html();
                        alert(document.getElementById("t_igst_rate").innerHTML);
                        //$('#lbl_Tot_duty_tariff').html();
                ...
                <TR>
                    ...
                    <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><A onclick="OpenValidUrl('<%=w_bcd_link_htm%>', '<%=w_bcd_link_pdf%>');
                            ...
                            <TD bgColor="#ffffff" align="center"><B> 
                                    <input id="idbcdamtnew" type="text" id="answer" style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;width:80%;" name="answer" value="<%--= bcdamtnew--%>" readonly/> 
