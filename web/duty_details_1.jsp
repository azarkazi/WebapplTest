...
//                        $('#t_aidc_rta').html(obj.bcd_rate);
                    ...
                    for (var i = 0; i < bcd_rta_op.length; i++) {
                        bcd_rtaSel.options[bcd_rtaSel.options.length] = new Option(bcd_rta_op[i].notn, bcd_rta_op[i].rta);
                    }
                    
                    var pref_rta_op = obj1["rs_prefnotn"];
                    for (var i = 0; i < pref_rta_op.length; i++) {
                        pref_rtaSel.options[pref_rtaSel.options.length] = new Option(pref_rta_op[i].notn, pref_rta_op[i].rta);
                    }
                    var adc_rta_op = obj1["rs_adcnotn"];
                    for (var i = 0; i < adc_rta_op.length; i++) {
                        adc_rtaSel.options[adc_rtaSel.options.length] = new Option(adc_rta_op[i].notn, adc_rta_op[i].rta);
                    }
                    var aidc_rta_op = obj1["rs_aidcnotn"];
                    for (var i = 0; i < aidc_rta_op.length; i++) {
                        aidc_rtaSel.options[aidc_rtaSel.options.length] = new Option(aidc_rta_op[i].notn, aidc_rta_op[i].rta);
                    }
                    var eaidc_rta_op = obj1["rs_eaidcnotn"];
                    for (var i = 0; i < eaidc_rta_op.length; i++) {
                        eaidc_rtaSel.options[eaidc_rtaSel.options.length] = new Option(eaidc_rta_op[i].notn, eaidc_rta_op[i].rta);
                    }
                    var echcess_rta_op = obj1["rs_chcessdd"];
                    for (var i = 0; i < echcess_rta_op.length; i++) {
                        echcess_rtaSel.options[echcess_rtaSel.options.length] = new Option(echcess_rta_op[i].notn, echcess_rta_op[i].rta);
                    }
                    var eigstcess_rta_op = obj1["rs_igstddcess"];
                    for (var i = 0; i < eigstcess_rta_op.length; i++) {
                        eigstcess_rtaSel.options[eigstcess_rtaSel.options.length] = new Option(eigstcess_rta_op[i].notn, eigstcess_rta_op[i].rta);
                    }
                    var sws_rta_op = obj1["rs_sws"];
                    for (var i = 0; i < sws_rta_op.length; i++) {
                        sws_rtaSel.options[sws_rtaSel.options.length] = new Option(sws_rta_op[i].notn, sws_rta_op[i].rta);
                    }
...
--%>
        ...
        <TABLE  cellSpacing="0" cellPadding="3" width="93%"  border="1" style="border-color: darkgray;border-collapse: collapse;">
            ...
            <TBODY>
                ...
                <TR>
                    ...
                    <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><span id="t_bcd_rta"></span><%--= t_bcd_rta--%></B></TD>
                    <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_bcd_amts%>&nbsp;<%= t_bcd_flg--%> </B></TD>
                    <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_bcd_uqc--%></B></TD>
                    ...
                    <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><A onclick="OpenValidUrl('<%=w_bcd_link_htm%>', '<%=w_bcd_link_pdf%>');
                                return false;"><B><%= notn%>-<%= notnslno%></B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</A>
                                    <% } else {--%>
                            <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                    <% //}%>
                            ...
                            <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="bcdSprtaElm"><%--= e_bcd_amts%></B>&nbsp;<B id="bcdflgElm"><%= e_bcd_flg--%></B></TD>
                            <TD bgColor="#ffffff" align="center"><B style="color:#000066;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="bcdSpUqcElm"><%--= e_bcd_uqc--%></B></TD>
                ...
                <TR><td colspan="9" style="display:none;">
                    ...
                    <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                    <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"></FONT></TD>
                    <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>

                    <%--if (p_pref_notn.equals("")) {
                    %>  <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue">
                            <%} else {--%>
                            <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue"><%--= p_pref_notn%>-<%= p_pref_slno--%>

                                    <%//}%>
                                    <select id="ddltopic" width="250px" id="ddl_pref_rta" style="width:250px;font-size:small;background-color:cornsilk;font-weight: 300;" onchange="On_pref_rta_Change(this);">
                                        <%--= pref_rta_OptionList--%>
                                    </select>
                                </FONT></TD>
                            <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="p_pref_effELM"><%--= p_pref_rta--%> </B></FONT></TD>
                    <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                    <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
       ...
       if ((t_adc_rta == "" || t_adc_rta == "0") && (t_adc_amts == "" || t_adc_amts == "0")) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><span id="t_adc_rta"></span><%--= t_adc_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_adc_amts%>&nbsp;<%= t_adcflg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_adc_uqc--%></B>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%= adc_notn%>-<%= adc_notnslno%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                ...
                                --%>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="adcrtaElm"><%--= e_adc_rta--%>  </B></TD>

                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="adcSprtaElm"><%--= e_adc_amts%></B>&nbsp;<B id="adcflgElm"><%= e_adc_flg--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="adcSpUqcElm"><%--=e_adc_uqc--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><span id="t_aidc_rta"></span><%--= t_aidc_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_aidc_amts%>&nbsp;<%= t_bcd_flg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_aidc_uqc--%></B>
                        <%-- if (bcdrta != "" && Double.parseDouble(bcdrta) > 0.0) {%>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%= aidc_notn1%>-<%= aidc_notnslno1%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                ...
                                --%>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="aidcrtaElm"><%--= e_aidc_rta--%>  </B></TD>

                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="aidcSprtaElm"><%--= e_aidc_amts%></B>&nbsp;<B id="aidcflgElm"><%= e_aidc_flg--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="aidcSpUqcElm"><%--=e_aidc_uqc--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_chcess_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_chcess_amts%>&nbsp;<%= t_chcess_flg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_chcess_uqc--%></B>
                ...
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="echcessrtaElm"><%--=t_chcess_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="echcessSprtaElm"><%--=e_chcess_amts%></B>&nbsp;<B  id="echcessFlgElm"><%=e_chcess_flg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="echcessSpUqcElm"><%--=e_chcess_uqc--%></B></TD>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_cessrta--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_cessamts--%></B></TD>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="cesrtaElm"> <%--= t_cessrta--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="cessSprtaElm"><%--=t_cessamts--%></B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B><%=t_cessuqc%></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                        <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= ncdrta--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= ncdamts%></B><B><%= ncdflg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= ncduqc--%></B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue"><B></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="nccdrtaElm"><%--= ncdrta--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="nccdamtsElm"><%--= ncdamts%></B><B id="nccdflgElm"><%= ncdflg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="nccduqcElm"><%--= ncduqc--%></B></TD>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_hlthrta--%> </B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_hlthamts%><%= t_hlthflg--%></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_hlthuqc--%> </B></font></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue"></font></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="hltrtaElm"><%--= t_hlthrta--%> </B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="hltamtsElm"><%--= t_hlthamts%> </B><B id="hltflgElm"><%= t_hlthflg--%></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="hltuqcElm"><%--= t_hlthuqc--%> </B></font></TD>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_eaidc_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_eaidc_amts%>&nbsp;<%= t_bcd_flg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_eaidc_uqc--%></B>
                        <%-- if (bcdrta != "" && Double.parseDouble(bcdrta) > 0.0) {%>
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= eaidc_notn1%>-<%= eaidc_notnslno1--%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                ...
                                --%>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="eaidcrtaElm"><%--= e_eaidc_rta--%>  </B></TD>

                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="eaidcSprtaElm"><%--= e_eaidc_amts%></B>&nbsp;<B id="eaidcflgElm"><%= e_eaidc_flg--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="eaidcSpUqcElm"><%--=e_eaidc_uqc--%></B></TD>
                        <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                                <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_sws_rt--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                ...
                <TD bgColor="#ffffff" align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="swsrtaElm"><%--=t_sws_rt--%></B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                            <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR s>
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"> <%--= anti_rta--%></B></TD>
                <TD align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=anti_amts--%></B></TD>
                <TD  align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="antdprtaElm"><%--= anti_rta--%></B></TD>
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="antdpSprtaElm"><%--= anti_amts--%></B></TD>
                <TD  align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
           ...
           <TR>
            ...
            <TR >
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= safeg_rta--%></B></TD>
                <TD align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=safeg_amts--%></B></TD>
                <TD  align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="sfgrtaElm"><%--= safeg_rta--%></B></TD>
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="sfgSprtaElm"><%--= safeg_amts--%></B></TD>
                <TD  align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                        <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= cntv_rta--%></B></TD>
                <TD align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= cntv_amts--%></B></TD>
                <TD  align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                ...
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="cntvrtaElm"><%--= cntv_rta--%></B></TD>
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="cntvSprtaElm"><%--= cntv_amts--%></B></TD>
                <TD  align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD  align="center"><B style="color:darkblue;font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                        <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_igst_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD bgColor="#ffffff" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                            <%--if (t_igst_notn.equals("")) {%>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue">
                        <%} else {--%>
                        <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_igst_notn%>-<%= t_igst_slno--%>
                                <%//}%>
                                <select width="250px" style="width:250px;font-size:small;background-color:cornsilk;font-weight: 300;" onchange="On_igst_rta_Change(this);">
                                    <%--=eigst_rta_OptionList--%>
                                </select> </FONT></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;" id="eigstrtaElm"><%--=t_igst_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                <TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000066"><B></B></FONT></TD>
                            <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>
            ...
            <TR>
                ...
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=t_igstcess_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=e_igstcess_amts--%></B></TD>
                <TD bgColor="#ffffff" align="left"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--=e_igstcess_uqc--%></B></TD>
                        <%--if (t_igstcess_notn.equals("")) {
                        %><TD bgColor="#ffffff" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="darkblue">
                        <%} else {--%>
                        <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"><%--= t_igstcess_notn%>-<%= t_igstcess_slno--%>
                                <%//}%>
                ...
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="eigstcessrtaElm"><%--=t_igstcess_rta--%> </B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="eigstcessSprtaElm"><%--=e_igstcess_amts%></B>&nbsp;<B  id="eigstcessFlgElm"><%=e_igstcess_flg--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;"  id="eigstcessSpUqcElm"><%--=e_igstcess_uqc--%></B></TD>
                <TD bgColor="#ffffff" align="center"><B style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:small;font-weight: 300;">
                        <%--if (p_pref_rta != "" && Double.parseDouble(p_pref_rta) > 0.0) {%>  
